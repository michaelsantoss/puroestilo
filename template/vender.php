    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <?php 
          ...
          $id = $_GET['id'];
          $acao = "SELECT * FROM prod_disponiveis WHERE id_prod='$id'";
        ...
        <form action="acao/vender.php" method="POST">
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="nome" class="form-control" value="<?php echo $dados['nome']; ?>" name="<?php echo $dados['nome']; ?>" disabled>
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="number" id="qtd" class="form-control" value="<?php echo $dados['quantidade']; ?>" name="quantidade" max="<?php echo $dados['quantidade']; ?>">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="vv" class="form-control" value="<?php echo $dados['valor_venda']; ?>" name="vv" disabled>
